...
public class SPart implements Part {

	private int height = 2;
	private int width = 3;
	private Color color = new Color(0, 204, 255);
	private BasicSquare[][] part = new Square[height][width];
	private Position position = new Position(0, 0);
	private boolean isHorizontal = true;
	
	public SPart(Color background) {
		...
		part[0][0] = new Square(background, background);
		part[1][2] = new Square(background, background);
	}
